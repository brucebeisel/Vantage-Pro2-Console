...
enum class Forecast {
    ...
    PARTLY_CLOUDY_WITH_RAIN_LATER =         PARTLY_CLOUDY_BIT | CLOUD_BIT | RAIN_BIT,
    PARTLY_CLOUDY_WITH_SNOW_LATER =         PARTLY_CLOUDY_BIT | CLOUD_BIT | SNOW_BIT,
    PARTLY_CLOUDY_WITH_RAIN_OR_SNOW_LATER = PARTLY_CLOUDY_BIT | CLOUD_BIT | RAIN_BIT | SNOW_BIT
};
