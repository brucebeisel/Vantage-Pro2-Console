...
public:
    ...
    const Measurement<Temperature> &        getIndoorTemperature() const;
    const Measurement<Humidity> &           getIndoorHumidity() const;
    const Measurement<Temperature> &        getOutdoorTemperature() const;
    ...
    const Measurement<Humidity> &           getOutdoorHumidity() const;
...
private:
    ...
    static constexpr int INDOOR_TEMPERATURE_OFFSET = 9;
    static constexpr int INDOOR_HUMIDITY_OFFSET = 11;
    static constexpr int OUTDOOR_TEMPERATURE_OFFSET = 12;
    ...
    static constexpr int OUTDOOR_HUMIDITY_OFFSET = 33;
    ...
    Measurement<Temperature>          indoorTemperature;
    Measurement<Humidity>             indoorHumidity;
    Measurement<Temperature>          outdoorTemperature;
    ...
    Measurement<Humidity>             outdoorHumidity;
